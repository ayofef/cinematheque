...
const SectionMarkup = ({data, heading, children, path}) => {
                    ...
                    <Link to={path}>
                        <h2 className={["markupHeading", `${classes.section__Heading}`].join(" ")}>
                            ...
                            <span>
                                ...
                                <div className={classes.section__Heading_arrow}><FontAwesomeIcon style={IconStyle} icon={faArrowRight} /></div>
                            </span>
                        </h2>
                    </Link>
                </div>
                <div  className={classes.section__box}>
                        {
                            data.map(({title, id, poster_path, vote_average}) => {
                                ...
                                <MovieCard key={id} path={`/home/${id}`} Imgs={poster_path} title={title} rating={vote_average}/>
